...
# Holy cow. The mean squared error is in the tens of billions. That is incredibly high. To give some context on what mean squared
...
# error in the tens of billions is pretty dismal. 
...
# The R-squared returns roughly 33-34%. This means the ranger model is only explaining about 33-34% of the 
...
# accuracy of prediction models. Again, our ranger random forest model gave us a 33-34 percent r-squared. That is comparable
# to our predictions on the train test set. We definitely
...
# The mean squared error is in the tens of billions. This is unsurprising, as it was very high on the train_test data set.
# We went from 68 billion on the train-test set to 69 billion on the final test set. Of course, this is not ideal.
...
# The R-squared returns roughly 33-34 percent This means the ranger model is only explaining about 33-34% of the 
# variability within the dataset. This is very comparable to the 33-34% the train_test set's result. It looks like
...
# The RMSE is roughly 366,000. This is relatively poorly comparable to the roughly 222,000 we had before. It's over a 50% swing,
